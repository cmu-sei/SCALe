...
module Scale
  class Application < Rails::Application
    config.ids = [11, 12, 21, 22, 23, 24, 25, 26, 31, 32, 33, 34, 35, 36, 41, 42, 53, 91, 92, 93]
    config.names = ["gcc", "rosecheckers", "msvc", "pclint", "fortify", "coverity", "ldra", "cppcheck", "eclipse", "findbugs","fortify","coverity", "javacheck", "findsecbugs", "perlcritic", "blint", "fortify", "lizard", "ccsm", "understand"]
    config.platforms = ["c", "c", "c", "c", "c", "c", "c", "c", "java", "java", "java",  "java", "java", "java", "perl", "perl", "js", "metric", "metric", "metric"]
