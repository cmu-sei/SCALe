...
$(".projects.toolUpload").ready(function() {
  tool_upload_setup();
});

function tool_upload_setup(form_element = null) {

  //console.log("tool_upload_setup()");

  var form_element = form_element || $("#toolUpload-form");
  var form_element_prefix = "#upload_tools_"
  ...
  var submit_button_selector = ".toolUpload-submit";
  ...
  function _refresh_display() {
    ...
    add_list.find(".list-item").each(function() {
      ...
      //selected_items[_item_id($(this))] ? $(this).attr("style", "display: none") : $(this).attr("style", "");
    });
