...
$(".projects.langUpload").ready(function() {
  lang_upload_setup();
});

function lang_upload_setup(form_element = null) {

  //console.log("lang_upload_setup()");

  var form_element = form_element || $("#langUpload-form");
  var form_element_prefix = "#upload_langs_"
  ...
  var submit_button_selector = ".langUpload-submit";
