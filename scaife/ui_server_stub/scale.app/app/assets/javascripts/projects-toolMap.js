...
$(".projects.toolMap").ready(function() {
  tool_map_setup();
});


function tool_map_setup(form_element = null) {

  //console.log("tool_map_setup()");

  var form_element = form_element || $("#toolMap-form");
  var form_element_prefix = "#map_tools_"

  var src_list_selector = ".src-tool-list";
  var tgt_list_selector = ".tgt-tool-list";
  var map_list_selector = ".map-tool-list";
  var map_button_selector = ".map-tool-button";
  var unmap_button_selector = ".unmap-tool-button";
  var submit_button_selector = ".toolMap-submit";
  ...
  form_element.find(submit_button_selector).click(function(e) {
    ...
    if ($.isEmptyObject(mapped_items)) {
      alert("At least one tool must be mapped");
      return false;
    }
    */
    var src_list = form_element.find(src_list_selector);
