...
module Datahub
  ...
  class ClassifierProject
    ...
    attr_accessor :adaptive_heuristic_is_active
    ...
    def self.attribute_map
      {
        ...
        :'adaptive_heuristic_is_active' => :'adaptive_heuristic_is_active',
    ...
    def self.openapi_types
      {
        ...
        :'adaptive_heuristic_is_active' => :'Boolean',
        :'uploader_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Scaife::Api::Datahub::ClassifierProject` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Scaife::Api::Datahub::ClassifierProject`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'adaptive_heuristic_is_active')
        self.adaptive_heuristic_is_active = attributes[:'adaptive_heuristic_is_active']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          adaptive_heuristic_is_active == o.adaptive_heuristic_is_active &&
    ...
    def hash
      [project_id, project_name, project_description, package, meta_alerts, taxonomies, author_source, adaptive_heuristic_is_active, uploader_id, uploader_organization_id, created_at, updated_at].hash
    end
