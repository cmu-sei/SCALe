...
module OpenapiClient
  class CascadeProject
    # Type of cascading to perform for this upload. Uses default if None provided.
    attr_accessor :cascading_type

    # Use an existing DataHub project with this ID to perform the cascading.
    attr_accessor :cascading_project_id

    attr_accessor :cascading_data
    ...
    def self.attribute_map
      {
        ...
        :'cascading_project_id' => :'cascading_project_id',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CascadeProject` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CascadeProject`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cascading_project_id')
        self.cascading_project_id = attributes[:'cascading_project_id']
      end

      if attributes.key?(:'cascading_data')
        self.cascading_data = attributes[:'cascading_data']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cascading_project_id == o.cascading_project_id &&
          cascading_data == o.cascading_data
    end
    ...
    def hash
      [cascading_type, cascading_project_id, cascading_data].hash
    end
